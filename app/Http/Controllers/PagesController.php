...
class PagesController extends Controller
{
    ...
    public function page($slug)
    {
        ...
        $price = collect();
        $price->minimal = $min_multipl * $index;
        ...
        switch ($slug) {
            ...
            // check courses
            case 'courses':
                return view('pages.courses-page', ['courses' => Course::where('active', 1)->orderBy('id', 'desc')->get()->translate(App::currentLocale())]);
                break;
            // check blog
            case 'blog':
                return view('pages.blog-category-page');
                break;
            // check online
            case 'online':
