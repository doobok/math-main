...
export default new MLCreate({
  ...
  languages: [
    new MLanguage('ru').create({
        ...
        pricePackage: 'стоимость абонемента',
        priceLesson: 'стоимость урока',
        getTutorbtn: 'стать репетитором',
    ...
    new MLanguage('uk').create({
        ...
        pricePackage: 'вартість абонементу',
        priceLesson: 'вартість уроку',
        getTutorbtn: 'стати репетитором',
