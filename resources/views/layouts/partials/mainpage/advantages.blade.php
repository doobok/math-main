  ...
  <div class="container mx-auto px-4 lg:pt-24 lg:pb-24">
    <div class="flex flex-wrap text-center justify-center">
      <div class="w-full lg:w-6/12 px-4">
        <h2 class="text-4xl font-semibold text-white">Чому обирають наш репетиторський центр?</h2>
    ...
    <div class="mx-auto px-4 mt-12">
      <div class="items-center flex flex-wrap">
        ...
        <div class="flex flex-wrap w-full md:w-7/12 ml-auto mr-auto px-4">
            ...
            <div class="w-full md:w-1/2 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Гнучкий графік</h6>
            ...
            <div class="w-full md:w-1/2 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Націленість на результат</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Divide details about your product or agency work into parts.
                    A paragraph describing a feature will be enough.
                  </p>
            ...
            <div class="w-full md:w-1/2 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Ефективна система навчання</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Divide details about your product or agency work into parts.
                    A paragraph describing a feature will be enough.
                  </p>
            ...
            <div class="w-full md:w-1/2 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Онлайн платформа</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Divide details about your product or agency work into parts.
                    A paragraph describing a feature will be enough.
                  </p>
