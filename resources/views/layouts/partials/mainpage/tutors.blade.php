        ...
        <div class="lg:pt-12 pt-4 w-full md:w-4/12 px-4 text-center">
          ...
          >
            <div class="px-4 py-5 flex-auto">
              ...
              <p class="mt-2 text-gray-900 bg-green-100 p-2 shadow-lg rounded-lg">
